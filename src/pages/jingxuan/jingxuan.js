...
import JxHeader from '../../components/fenleilist/listheader';
import JxGoodsList from '../../components/fenleilist/listcontent';
import JingxuanTop from '../../components/jingxuan/jingxuantop';
import JingxuanBottom from '../../components/jingxuan/jingxuanbottom';
import JingxuanToTop from '../../components/toTop/toTop';
...
export default class ShopList extends Component{
    ...
    componentWillMount(){
        // console.log(this.props.location.hash.slice(1,)*1)
        var self = this;
        var zidx = this.props.location.hash.slice(1,)*1;
        this.setState({
            title: self.state.jxBottomData[zidx].name,
            url: 'biao='+self.state.jxBottomData[zidx].biao+'&sort='+self.state.jxBottomData[zidx].sort,
            topData: {
                imgSrc: self.state.jxBottomData[zidx].src,
                text: self.state.jxBottomData[zidx].jianjie,
            }
        })
        console.log(this.props)
    }
    render(){
        let jingxuanName = this.state.title;
        let jingxuanUrl = this.state.url;
        let jingxuantopdata = this.state.topData;
        return (
            <div className="jingxuan" style={{backgroundColor:'#f0f0f0',}}>
                <JxHeader name={jingxuanName} />
                <JingxuanTop name={jingxuanName} topData={jingxuantopdata} />
                <JxGoodsList url={jingxuanUrl} />
                <JingxuanBottom />
                <JingxuanToTop />
            </div>
            )
